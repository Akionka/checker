...
local headerTextBuffer = imgui.ImBuffer('Users online', 65)
      ...
      if selectedTab == 2 then
        imgui.BeginGroup()
          imgui.BeginChild('Center panel')
            ...
            if moonloaderVersion >= 027 and imgui.Checkbox('Всегда автоматически проверять обновления', imgui.ImBool(data.settings.alwaysAutoCheckUpdates)) then
